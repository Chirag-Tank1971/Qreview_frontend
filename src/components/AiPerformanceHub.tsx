...
export const AiPerformanceHub: React.FC<AiPerformanceHubProps> = ({ currentUser }) => {
  ...
  const loadBaseData = async () => {
    ...
    try {
      const [empData, fbData, pipData, talentData] = await Promise.all([
        api.getEmployees(),
        api.getFeedback(),
        api.getPips(),
  ...
  return (
    <div id="ai_performance_hub_container" className="space-y-6">
      ...
      {/* Navigation Tabs */}
      <div id="ai_hub_tabs" className="flex border-b border-slate-200 bg-white rounded-t-xl px-4 pt-3 overflow-x-auto gap-2">
        <button
      ...
      {activeTab === 'synthesis' && (
        <div id="tab_content_synthesis" className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-b-xl p-6 shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Controls Column */}
              <div className="space-y-5 border-r border-slate-100 pr-0 lg:pr-6">
                <div>
                ...
                {selectedEmployee && (
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2 text-xs">
                    ...
                    <div className="text-slate-600">
                      Code: <span className="font-mono">{selectedEmployee.employeeCode}</span>
                    </div>
                    <div className="text-slate-600">
                      Dept: <span className="font-medium text-slate-800">{selectedEmployee.departmentName || selectedEmployee.departmentId}</span>
                    </div>
                    <div className="text-slate-600">
              ...
              <div className="lg:col-span-2 space-y-4">
                {!synthesisResult && !synthesizing && (
                  <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50 border border-dashed border-slate-200 rounded-xl min-h-[360px]">
                    <Sparkles className="w-12 h-12 text-indigo-300 mb-3" />
                    <h3 className="text-base font-semibold text-slate-700">Ready to Draft Executive Appraisals</h3>
                ...
                {synthesizing && (
                  <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50 border border-slate-200 rounded-xl min-h-[360px]">
                    <div className="w-12 h-12 rounded-full border-4 border-indigo-200 border-t-indigo-600 animate-spin mb-4" />
                    <h3 className="text-sm font-semibold text-slate-800">Synthesizing Performance Narrative</h3>
                  ...
                  <div className="space-y-4 animate-in fade-in duration-300">
                    ...
                    <div className="p-4 bg-indigo-50/50 border border-indigo-100 rounded-xl">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        >
                          {copiedSection === 'exec' ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Copy className="w-3.5 h-3.5" />}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 bg-emerald-50/40 border border-emerald-200/60 rounded-xl">
                        <div className="text-xs font-bold uppercase tracking-wider text-emerald-900 flex items-center gap-1.5 mb-2">
                      ...
                      <div className="p-4 bg-amber-50/40 border border-amber-200/60 rounded-xl">
                        <div className="text-xs font-bold uppercase tracking-wider text-amber-900 flex items-center gap-1.5 mb-2">
                    ...
                    <div className="p-4 bg-white border border-slate-200 rounded-xl space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {copiedSection === 'narrative' ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Copy className="w-3.5 h-3.5" />}
                    ...
                    <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {synthesisResult.recommendedDevelopmentGoals.map((g, i) => (
                          <div key={i} className="p-2.5 bg-white border border-slate-200 rounded-lg text-xs text-slate-700 flex items-start gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-slate-500">Unconscious Bias & Tone Audit</span>
                </div>
                ...
                <textarea
                  ...
                  className="w-full p-3.5 text-xs text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none leading-relaxed"
                />
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="px-2.5 py-1 text-xs font-bold text-indigo-700 bg-indigo-50 border border-indigo-100 rounded-lg min-w-[50px] text-center">
                        {biasRatingScore} / 5
                      </span>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                {!biasResult && !analyzingBias && (
                  <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50 border border-dashed border-slate-200 rounded-xl min-h-[300px]">
                    <ShieldCheck className="w-10 h-10 text-indigo-300 mb-2" />
                    <h3 className="text-sm font-semibold text-slate-700">AI Bias & Tone Evaluation</h3>
                ...
                {biasResult && (
                  <div className="space-y-4 animate-in fade-in duration-200">
                    ...
                    <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
                      <div>
                        <div className="text-xs text-slate-500 font-medium">Compliance Assessment</div>
                        <div className="text-base font-bold text-slate-900 mt-0.5 capitalize flex items-center gap-2">
                      ...
                      <div className="text-right">
                        <div className="text-xs text-slate-500 font-medium">Bias Risk Index</div>
                        <div className={`text-xl font-extrabold ${biasResult.biasScore > 35 ? 'text-amber-600' : 'text-emerald-600'}`}>
                      ...
                      <div className="p-4 bg-amber-50/60 border border-amber-200 rounded-xl space-y-2">
                        ...
                        <div className="space-y-2">
                          {biasResult.detectedIssues.map((iss, idx) => (
                            <div key={idx} className="text-xs bg-white p-2.5 rounded-lg border border-amber-200/80">
                              <div className="font-semibold text-rose-700">"{iss.phrase}"</div>
                              <div className="text-slate-600 mt-0.5">{iss.suggestion}</div>
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <div className="p-4 bg-emerald-50/50 border border-emerald-200 rounded-xl space-y-2">
                      ...
                      <p className="text-xs text-slate-800 bg-white p-3 rounded-lg border border-emerald-100 font-serif leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
              <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-800">Send 360° Feedback / Kudos</h3>
                  <p className="text-[11px] text-slate-500">Recognize peer contributions and link to KRA milestones</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSendFeedback} className="space-y-3.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-2.5 text-xs bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none leading-relaxed"
                    required
                  />
                </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <option value="kudos">Kudos Only</option>
                    <option value="growth_suggestion">Growth Suggestions</option>
              ...
              <div className="space-y-3">
                {filteredFeedbacks.length === 0 && (
                  <div className="p-8 text-center bg-white border border-slate-200 rounded-xl">
                    ...
                    <div className="text-xs text-slate-500 font-medium">No recognitions found matching this filter.</div>
                  </div>
                )}
                ...
                {filteredFeedbacks.map((item) => (
                  <div
                    ...
                    className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm hover:border-indigo-200 transition-all space-y-3"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                            ...
                            <span className="text-indigo-700">{item.toEmployeeName}</span>
                          </div>
                      ...
                      <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-slate-50 border border-slate-200 text-xs font-medium text-slate-700">
                        {getBadgeIcon(item.badgeCategory)}
                        <span className="text-[11px] font-semibold">{getBadgeLabel(item.badgeCategory)}</span>
                      </div>
                    </div>

                    <p className="text-xs text-slate-800 leading-relaxed pl-11 font-serif">
                      "{item.message}"
                    </p>

                    {item.linkedKraTitle && (
                      <div className="ml-11 px-2.5 py-1 bg-slate-50 rounded-md border border-slate-100 text-[11px] text-slate-600 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div className="p-3 rounded-lg bg-amber-50/50 border border-amber-200/70 min-h-[105px]">
                  <div className="text-[10px] font-bold text-amber-900 uppercase">Untapped Enigma</div>
                  <div className="text-[9px] text-amber-700">Low Perf • High Pot</div>
                    ...
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          ...
                          className="p-1.5 bg-white rounded border border-amber-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-amber-500 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
                ...
                <div className="p-3 rounded-lg bg-emerald-50/50 border border-emerald-200/70 min-h-[105px]">
                  <div className="text-[10px] font-bold text-emerald-900 uppercase">Growth Driver</div>
                  <div className="text-[9px] text-emerald-700">Med Perf • High Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-emerald-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-emerald-500 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
                ...
                <div className="p-3 rounded-lg bg-indigo-50 border-2 border-indigo-500 min-h-[105px] shadow-sm">
                  ...
                  <div className="text-[9px] text-indigo-700">High Perf • High Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-indigo-200 text-slate-800 font-bold cursor-pointer text-[11px] hover:border-indigo-600 shadow-2xs flex items-center justify-between"
                        >
                          <span>{t.employeeName}</span>
                          <span className="text-[10px] text-indigo-600 font-mono">{t.currentScore}</span>
                        </div>
                      ))}
                  </div>
                </div>
                ...
                <div className="p-3 rounded-lg bg-rose-50/40 border border-rose-200/70 min-h-[105px]">
                  <div className="text-[10px] font-bold text-rose-900 uppercase">Inconsistent Dilemma</div>
                  <div className="text-[9px] text-rose-700">Low Perf • Med Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-rose-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-rose-500 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
                ...
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 min-h-[105px]">
                  <div className="text-[10px] font-bold text-slate-800 uppercase">Core Contributor</div>
                  <div className="text-[9px] text-slate-500">Med Perf • Med Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-slate-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-slate-400 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
                ...
                <div className="p-3 rounded-lg bg-emerald-50/60 border border-emerald-300 min-h-[105px]">
                  <div className="text-[10px] font-bold text-emerald-900 uppercase">Key Asset</div>
                  <div className="text-[9px] text-emerald-700">High Perf • Med Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-emerald-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-emerald-500 shadow-2xs flex items-center justify-between"
                        >
                          <span>{t.employeeName}</span>
                          <span className="text-[10px] text-emerald-600 font-mono">{t.currentScore}</span>
                        </div>
                      ))}
                  </div>
                </div>
                ...
                <div className="p-3 rounded-lg bg-rose-100/50 border border-rose-300 min-h-[105px]">
                  <div className="text-[10px] font-bold text-rose-950 uppercase">Talent Risk / Action</div>
                  <div className="text-[9px] text-rose-800">Low Perf • Low Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-rose-300 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-rose-600 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
                ...
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 min-h-[105px]">
                  <div className="text-[10px] font-bold text-slate-700 uppercase">Effective Steady</div>
                  <div className="text-[9px] text-slate-500">Med Perf • Low Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                ...
                <div className="p-3 rounded-lg bg-blue-50/50 border border-blue-200 min-h-[105px]">
                  <div className="text-[10px] font-bold text-blue-900 uppercase">Trusted Professional</div>
                  <div className="text-[9px] text-blue-700">High Perf • Low Pot</div>
                  <div className="mt-2 space-y-1">
                    {talentRecords
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          onClick={() => setSelectedTalent(t)}
                          className="p-1.5 bg-white rounded border border-blue-200 text-slate-800 font-medium cursor-pointer text-[11px] hover:border-blue-500 shadow-2xs"
                        >
                          {t.employeeName}
                        </div>
                      ))}
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
              ...
              {selectedTalent ? (
                <div className="space-y-3.5 text-xs">
                  <div>
                    <div className="text-sm font-bold text-slate-900">{selectedTalent.employeeName}</div>
                    <div className="text-slate-500">{selectedTalent.designation} • {selectedTalent.department}</div>
                  </div>

                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1.5">
                    <div className="flex justify-between">
                      <span className="text-slate-500">Rollup Rating:</span>
                      <span className="font-bold text-slate-800">{selectedTalent.currentScore} / 5.00</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">9-Box Quadrant:</span>
                      <span className="font-bold text-indigo-700 capitalize">
                        {selectedTalent.nineBoxCategory.replace('_', ' ')}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">Succession Ready:</span>
                      <span className={`font-bold ${selectedTalent.successionReady ? 'text-emerald-700' : 'text-slate-600'}`}>
                    ...
                    {selectedTalent.targetNextRole && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-slate-800">{selectedTalent.targetNextRole}</span>
                      </div>
                    )}
                  </div>

                  <div>
                    <div className="font-semibold text-slate-700 mb-1">Recommended Talent Actions:</div>
                  ...
                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px]">
                    <span className="text-slate-400">Assessed: {selectedTalent.lastAssessedDate}</span>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                      <div className="text-sm font-bold text-slate-900 flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-500 font-normal">({pip.employeeCode})</span>
                  ...
                  <div>
                    <div className="flex justify-between text-xs font-semibold mb-1">
                      <span className="text-slate-600">Milestone Progression</span>
                      <span className="text-indigo-700">{pip.overallProgress}% Completed</span>
                    </div>
                    ...
                    {pip.milestones.map((m) => (
                      ...
                      >
                        <div>
                          ...
                          <div className="text-[10px] text-slate-500 mt-0.5">Target: {m.targetMetric}</div>
                        </div>
                        <span
                  ...
                  {pip.checkins.length > 0 && (
                    <div className="pt-2 border-t border-slate-200/70">
                      <div className="text-[11px] font-bold text-slate-600 uppercase mb-1.5">
              ...
              <div className="lg:col-span-2 space-y-4">
                {!growthPlanResult && !generatingGrowthPlan && (
                  <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50 border border-dashed border-slate-200 rounded-xl min-h-[300px]">
                    ...
                    <h3 className="text-sm font-semibold text-slate-700">AI Upskilling & Progression Planner</h3>
                    <p className="text-xs text-slate-500 max-w-sm mt-1">
                ...
                {growthPlanResult && (
                  <div className="space-y-4 animate-in fade-in duration-200">
                    <div className="p-4 bg-indigo-50 border border-indigo-100 rounded-xl flex items-center justify-between">
                      <div>
                        <div className="text-xs font-bold text-indigo-900 uppercase">Recommended Track</div>
                        <div className="text-sm font-bold text-indigo-700 mt-0.5">
                          {growthPlanResult.recommendedTrack}
                        </div>
                      </div>
                      <span className="px-3 py-1 bg-white rounded-full text-xs font-bold text-indigo-800 border border-indigo-200 shadow-2xs">
                      ...
                      {growthPlanResult.milestones.map((m, idx) => (
                        <div key={idx} className="p-3.5 bg-white border border-slate-200 rounded-xl shadow-2xs space-y-1.5">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-bold text-slate-800">{m.focusArea}</span>
                          </div>
                          <p className="text-xs text-slate-700 leading-relaxed">
                            {m.actionableTask}
                          </p>
                          <div className="text-[11px] text-emerald-800 bg-emerald-50 px-2 py-1 rounded border border-emerald-100 flex items-center gap-1.5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-1">
                        ...
                        <p className="text-slate-600">{growthPlanResult.mentorProfileMatch}</p>
                      </div>
                      ...
                      <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-1">
                        ...
                        <p className="text-slate-600">{growthPlanResult.stretchProjectIdea}</p>
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="space-y-3 text-xs">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-full accent-indigo-600"
                  />
                  <span className="font-bold text-indigo-700 bg-indigo-50 px-2 py-1 rounded border border-indigo-100 min-w-[50px] text-center">
                    {newCheckinRating} / 5
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
            </div>
