...
export const BellCurveBudgetAnalytics: React.FC<BellCurveBudgetAnalyticsProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-white border border-slate-200 rounded-2xl shadow-2xs">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <select
            ...
            className="text-xs bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 font-medium text-slate-800 focus:outline-none focus:ring-1 focus:ring-indigo-500"
          >
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                <h5 className="text-sm font-bold text-slate-900">{deptCurve.departmentName}</h5>
                        ...
                        <div className="space-y-2 pt-2 border-t border-slate-100">
                          ...
                          <div className="w-full h-7 rounded-xl overflow-hidden flex p-1 bg-slate-100 gap-1">
                                  ...
                                  <div className="text-[10px] text-slate-500 flex items-center justify-between">
                                    ...
                                    <span
                                      className={`font-mono font-semibold ${
                                        b.deltaPercent > 0 ? 'text-amber-600' : 'text-slate-600'
                                      }`}
                                    >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3.5">
                <div className="p-4 bg-white border border-slate-200 rounded-2xl shadow-2xs space-y-1">
                  ...
                  <div className="text-[11px] text-slate-500">Total base CTC annualized</div>
                </div>
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-2xl shadow-2xs space-y-1">
                  ...
                  <div className="text-[11px] text-slate-500">Approved organizational budget limit</div>
                </div>
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-2xl shadow-2xs space-y-1">
                  ...
                  <div className="text-[11px] text-slate-500">Unallocated reserve pool</div>
                </div>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            <div className="flex items-center gap-2">
                              <h5 className="text-sm font-bold text-slate-900">{pool.departmentName}</h5>
                              <span
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-[10px] text-slate-400">Actual pool spend rate</div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                          <div className="flex items-center justify-between text-xs">
                            <span className="text-slate-600 font-medium">Spent vs Budget Cap ({pool.budgetCapPercent}%)</span>
                            <span className="font-mono font-bold text-slate-900">{spendPercentage}% of Cap</span>
                          </div>
                        ...
                        <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100 text-xs">
                          ...
                          <div className="p-2.5 bg-slate-50 rounded-xl">
                            <div className="text-[10px] text-slate-500 uppercase font-semibold">Actual Spent</div>
                            <div className={`text-sm font-bold font-mono ${pool.isOverBudget ? 'text-rose-700' : 'text-emerald-700'}`}>
                              {currencySymbol}{(pool.actualSpentAmount / 100000).toFixed(2)}L
                            </div>
                          </div>
                          <div className="p-2.5 bg-slate-50 rounded-xl">
                            <div className="text-[10px] text-slate-500 uppercase font-semibold">Remaining Pool</div>
                            <div className={`text-sm font-bold font-mono ${pool.remainingBudgetAmount < 0 ? 'text-rose-600' : 'text-blue-700'}`}>
                  ...
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {data.attritionRiskInsights.map((risk) => (
                        <tr key={risk.employeeId} className="hover:bg-slate-50/80 transition-colors">
                          <td className="px-4 py-3 font-medium text-slate-900">
                            <div>{risk.employeeName}</div>
                            <div className="text-[11px] text-slate-500 font-mono">{risk.employeeCode} • {risk.designationName}</div>
                          </td>
                          <td className="px-4 py-3 text-slate-700">{risk.departmentName}</td>
                          ...
                          <td className="px-4 py-3 text-slate-600 max-w-xs space-y-0.5">
                            <div className="text-[11px] font-medium text-slate-800">{risk.riskReason}</div>
                            <div className="text-[10px] text-indigo-700 font-semibold">{risk.recommendedRetentionAction}</div>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-slate-900">{cycleItem.cycleName}</span>
                      </div>
                      <span
                        className={`px-1.5 py-0.2 rounded text-[9px] font-bold ${
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between text-xs text-slate-500">
                        ...
                        <strong className="text-slate-800">{cycleItem.appraisalMonthName}</strong>
                      </div>
                      <div className="flex items-center justify-between text-xs text-slate-500">
                        <span>Headcount</span>
                        <strong className="font-mono text-slate-900">{cycleItem.headcount} emp</strong>
                      </div>
                      <div className="flex items-center justify-between text-xs text-slate-500">
                        <span>Avg Increment</span>
                        <strong className="font-mono text-emerald-700">+{cycleItem.avgIncrement}%</strong>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1 pt-1">
                      <div className="flex items-center justify-between text-[10px] text-slate-500">
                        ...
                        <span className="font-mono font-bold text-slate-900">{cycleItem.completionPercent}%</span>
                      </div>
